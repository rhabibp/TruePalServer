...
set CLASSPATH=%APP_HOME%\lib\truepalserver-all.jar

@rem Execute truepalserver
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TRUEPALSERVER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TRUEPALSERVER_EXIT_CONSOLE%" exit 1
exit /b 1
